...
For more details on X-13ARIMA-SEATS, as well as for explanations on the X-13ARIMA-SEATS syntax, see the official [manual][manual] or the [quick reference][qref].
