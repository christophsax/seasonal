...
demo website (at \url{https://www.seasonal.website}) supports interactive
...
This is a version of our article in the \emph{Journal of Statistical Software}
(Sax and Eddelbuettel 2018).
}
...
\begin{center}
   ...
   \caption{The website \url{https://www.seasonal.website} gives a full-featured preview of the modeling facilities of \pkg{seasonal}, including the possibility to upload and adjust time series. \label{fig:website}}
\end{center}
\end{figure}
...
\url{https://www.seasonal.website}) allows uploading and modeling of
...
Box-Ljung (no autocorr.): 22.53   Shapiro (normality): 0.995
\end{CodeOutput}
...
\url{https://www.seasonal.website}:
...
\url{https://www.seasonal.website/examples.html} offers numerous
...
\url{https://www.seasonal.website}. To install the latest version of
